...
int main()
{
    ...
    node *mid;
    mid = find_mid(head, 1); // second agument is 1 if you want the first mid in linklist having even num of nodes and 0 if you want second mid for even length of linklist.
    if (mid == NULL)
    {
